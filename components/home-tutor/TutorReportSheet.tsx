...
import { createTutorReport } from '@/lib/home-tutor-service';
import { cn } from '@/lib/utils';

const TUTOR_REPORT_REASONS = [
  'ভুয়া / মিথ্যা প্রোফাইল',
  'প্রফেশনাল আচরণ করছে না',
  'ভুয়া শংসাপত্র / যোগ্যতা',
  'ক্লাসে নিয়মিত অনুপস্থিত',
  'অনুপযুক্ত আচরণ',
  'অন্য কারণ',
];

interface TutorReportSheetProps {
  open: boolean;
  onClose: () => void;
  tutorId: string;
...
export function TutorReportSheet({ open, onClose, tutorId, user }: TutorReportSheetProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSending(true);
    setError('');
    const result = await createTutorReport({
      tutorId,
